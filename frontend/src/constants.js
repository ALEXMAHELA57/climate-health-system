...
export const T = {
  ...
  sw: {
    ...
    welcome:'Karibu', detect:'Inatafuta mahali ulipo...',
    locationOk:'Mkoa wako umepatikana', locationDenied:'GPS haifanyi kazi. Tafadhali chagua mkoa wako.',
    useGps:'Tumia GPS', riskThisWeek:'Hatari ya afya wiki hii',
    weekForecast:'Utabiri wa siku 7', dayForecast:'Utabiri wa siku 15',
    currentConditions:'Hali ya sasa', temperature:'Joto la hewa',
    humidity:'Unyevu wa hewa', wind:'Kasi ya upepo', rain7:'Mvua jumla siku 7',
    healthAlerts:'Tahadhari za Afya', search:'Tafuta',
    emergency:'Dharura', callEmergency:'Piga simu 112',
    findClinics:'Tafuta Kliniki', whenToGo:'Ni lini kwenda hospitali',
    afyaGreet:'Habari! Mimi ni Afya, msaidizi wako wa afya. Unajisikiaje leo?',
    typeSymptoms:'Eleza dalili zako hapa...', typing:'Afya anaandika...',
    symptomTags:[
      'Homa','Maumivu ya kichwa','Kikohozi','Kizunguzungu',
      'Kichefuchefu','Kutapika','Kuharisha','Maumivu ya mwili',
      'Baridi kali','Upele wa ngozi','Koo kuuma','Uchovu mkubwa'
    ],
    riskMap:'Ramani ya Hatari ya Hali ya Hewa', overallRisk:'Hatari Jumla',
    malaria:'Malaria', flood:'Mafuriko', drought:'Ukame', outbreak:'Mlipuko wa Ugonjwa',
